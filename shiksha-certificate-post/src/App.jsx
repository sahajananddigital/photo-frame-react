...
const App = () => {
  ...
  const [text, setText] = useState("Student Name"); // First text box
  const [text2, setText2] = useState("1 month internship in ____"); // Second text box
  const [text3, setText3] = useState("College name:"); // Third text box
  ...
  const drawCanvas = () => {
    ...
    background.src = "./background.png"; // Replace with your background image path
    ...
    background.onload = () => {
      ...
      croppedImages.forEach((imageSrc, idx) => {
        if (imageSrc) {
          ...
          img.onload = () => {
            ...
            const cornerRadius = imageRadius;
      ...
      // Draw first text
      ctx.fillText(text, canvas.width / 2, canvas.height - 330);
  
      ctx.font = `bold 25px Montserrat`;
      ctx.fillStyle = "#ffffff";
      // Draw second text
      ctx.fillText(text2, canvas.width / 2, canvas.height - 170);

      // Draw third text
      ctx.fillText(text3, canvas.width / 2, canvas.height - 130);
    };
  };  
